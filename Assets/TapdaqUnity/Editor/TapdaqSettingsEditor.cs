...
public class TapdaqSettingsEditor : Editor {
	...
	{
		object[] knownGameObjectsInScene = GameObject.FindObjectsOfType(typeof (GameObject));
		foreach (GameObject knownGameObject in knownGameObjectsInScene)
		{
			if (knownGameObject.GetComponent<Tapdaq>()) {
